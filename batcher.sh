...
python main.py --model-name="ResNet18" --dataset-name="cifar100" --seed=$SEED
...
python main.py --model-name="ResNet18" --dataset-name="cifar10" --seed=$SEED
...
echo "Training MNIST"
python main.py --model-name="ResNet18" --dataset-name="mnist" --seed=$SEED
